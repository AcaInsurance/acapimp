...
public class InfoWellWomanActivity extends ControlNormalActivity {
...
private Bundle b;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_well_woman);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_well_woman, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_well_woman_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_well_woman_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_well_woman_procedure, "Prosedur Klaim", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v) {
		...
		{
			Intent i = new Intent(getBaseContext(),  FillWellWomanActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
