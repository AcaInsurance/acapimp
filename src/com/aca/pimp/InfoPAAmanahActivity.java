...
public class InfoPAAmanahActivity extends ControlNormalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_paamanah);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_paamanah, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_paamanah_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_paamanah_facility, "Golongan Pekerjaan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_paamanah_procedure, "Perluasan Jaminan", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v) {
		...
		{
			Intent i = new Intent(getBaseContext(),  FillPAAmanahActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
