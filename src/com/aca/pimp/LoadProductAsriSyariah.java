...
public class LoadProductAsriSyariah extends AsyncTask<String, Void, Void>{
    ...
    public LoadProductAsriSyariah (Context ctx, String policyNo, Long SPPA_ID, ArrayList<HashMap<String, String>> polis){
    	this.ctx = ctx;
    	noPolis = policyNo;
    	polisList = polis;
	...
	protected void onPostExecute(Void result) {
		...
		try
		{
			dba = new DBA_PRODUCT_ASRI_SYARIAH(ctx);
