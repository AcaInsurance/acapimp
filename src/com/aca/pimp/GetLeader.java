...
public abstract class GetLeader extends AsyncTask<String, Void, Void>{
	private static String NAMESPACE = "http://tempuri.org/";     
    private static String URL = Utility.getURL(); 
    
    private static String SOAP_ACTION = "http://tempuri.org/GetLeader";     
    private static String METHOD_NAME = "GetLeader";
	...
	public GetLeader (Context context, HashMap<String, String> map ) {
			...
			try{   
	            ...
	            if(responseBody.getPropertyCount() > 0) {
	            	...
	            	for (int i = 0; i < table.getPropertyCount(); i++) {
		                ...
		                map.put("ID_LEADER", Utility.isAnytype(tableRow.getPropertySafelyAsString("ID_LEADER"))); 
	            	...
	            	error = true;
	            	errorMessage = "Data Leader tidak ditemukan";
	            } 
			}	
			catch (Exception e) { 
        		error = true;
		...
		protected abstract void getLeaderList(ArrayList<HashMap<String, String>> arrList)  ;
