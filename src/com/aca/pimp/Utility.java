...
//	acAsqlsvr_88
	...
	public static String sqlDatePattern = "yyyy-MM-dd";
...
//	private static final String imageURL = "http://182.23.65.68/mobilepimptest/WsSaveImage.asmx";
//	private static final String sppaImageURL = "http://182.23.65.68/mobilepimptest/document/";
	
//
//	private static final String imageURL = "http://182.23.65.68/mobilepimp/WsSaveImage.asmx";
//	private static final String sppaImageURL = "http://182.23.65.68/mobilepimp/document/";
	

	
	private static final String imageURL = "http://172.16.88.31/mobilepimptest/WsSaveImage.asmx";
	private static final String sppaImageURL = "http://172.16.88.31/mobilepimptest/document/";

	
	
//	private static final String hardCodeURL = "http://182.23.65.68/wsgetdatapimp/service.asmx";
//	private static final String hardCodeURL = "http://182.23.65.68/wsgetdatapimptest/service.asmx";
	private static final String hardCodeURL = "http://172.16.88.31/wsgetdatapimptest/service.asmx";

	private static String URL = hardCodeURL;
	
	private static Activity tempActivity = null;
	@SuppressWarnings("unused")
	private static final String TAG = "com.aca.pimp.Utility";
	...
	public static void BindJenisID(final Spinner s, Context ctx, Activity act) {

		final List<SpinnerGenericItem> spinnerGenericList = new LinkedList<SpinnerGenericItem>();
		final SpinnerGenericAdapter spinnerGenericAdapter = new SpinnerGenericAdapter(spinnerGenericList, act);
		 

		GetJenisID ws = new GetJenisID(ctx, new HashMap<String, String>()) {
			
			private String id;
			private String desc;

			@Override
			protected void getJenisIdList(ArrayList<HashMap<String, String>> arrList) {
				if (arrList != null) {
					for (HashMap<String, String> map : arrList) {
						id = map.get("JENIS_ID");
						desc = map.get("DESCRIPTION"); 
						spinnerGenericList.add(new SpinnerGenericItem(id,desc));						
					}
	...
	public static void BindBranch(Spinner s, Context ctx, Activity act) {

		List<SpinnerGenericItem> spinnerGenericList = new LinkedList<SpinnerGenericItem>();
		SpinnerGenericAdapter spinnerGenericAdapter = new SpinnerGenericAdapter(spinnerGenericList, act);
		
		spinnerGenericList.add(new SpinnerGenericItem("00","HO"));
		spinnerGenericList.add(new SpinnerGenericItem("01","KCK"));
		spinnerGenericList.add(new SpinnerGenericItem("02","AMBAS"));
		spinnerGenericList.add(new SpinnerGenericItem("03","MATRAMAN"));
		
		s.setAdapter(spinnerGenericAdapter);
	}
	

	public static void BindUserID(Spinner s, Context ctx, Activity act) {

		List<SpinnerGenericItem> spinnerGenericList = new LinkedList<SpinnerGenericItem>();
		SpinnerGenericAdapter spinnerGenericAdapter = new SpinnerGenericAdapter(spinnerGenericList, act);
		

		spinnerGenericList.add(new SpinnerGenericItem("0",""));
		spinnerGenericList.add(new SpinnerGenericItem("1","068899"));
		spinnerGenericList.add(new SpinnerGenericItem("2","000000"));
		spinnerGenericList.add(new SpinnerGenericItem("3","077900"));
		spinnerGenericList.add(new SpinnerGenericItem("4","077910"));
		
		s.setAdapter(spinnerGenericAdapter);
	}
	

	public static void BindLeader(Spinner s, Context ctx, Activity act) {

		List<SpinnerGenericItem> spinnerGenericList = new LinkedList<SpinnerGenericItem>();
		SpinnerGenericAdapter spinnerGenericAdapter = new SpinnerGenericAdapter(spinnerGenericList, act);
		

		spinnerGenericList.add(new SpinnerGenericItem("",""));
		spinnerGenericList.add(new SpinnerGenericItem("0","MARSEL"));
		spinnerGenericList.add(new SpinnerGenericItem("1","WILLIAM"));
		spinnerGenericList.add(new SpinnerGenericItem("2","RENDY"));
		spinnerGenericList.add(new SpinnerGenericItem("3","BENY"));
		spinnerGenericList.add(new SpinnerGenericItem("4","SAMUEL"));
	...
	public static String getProductNameBySPPAno (String SPPA_NO ){
		...
		if(SPPA_NO.equals("01")) return "ASRI";
			else if (SPPA_NO.equals("02")) return "Konvensional";		
			...
			else if (SPPA_NO.equals("16")) return "WellWoman";
			else if (SPPA_NO.equals("17")) return "DNO";
...
//	}
	...
	*/
	...
	public static void DeleteDirectory(long RowID){
		File directory = new File(Environment.getExternalStorageDirectory() + "/LoadImgPimp/" + String.valueOf(RowID));
		if(directory.exists()){
			try {
	...
	public static String isAnytype (String value) {
	...
	public static String formatDate (String myDate, String oldPattern, String newPattern) {
		...
		try {
			Date newDate = oldDateFormat.parse(myDate);
	...
	public static String formatDateSQL (String myDate) {
		SimpleDateFormat oldDateFormat = new SimpleDateFormat(sqlDatePattern);
		SimpleDateFormat newDateFormat = new SimpleDateFormat(standardDatePattern);
	...
	public static int yearDiff (String firstDate, String secondDate) { 
		...
		try {
			LocalDate fDate = formatter.parseLocalDate(firstDate); 
			LocalDate sDate = formatter.parseLocalDate(secondDate);  
			yeardiff = Years.yearsBetween(fDate , sDate ).getYears();
		}
		catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public static int monthDiff (String firstDate, String secondDate) { 
		DateTimeFormatter formatter = DateTimeFormat.forPattern("dd/MM/yyyy");
		int monthdiff = 0;
		...
		try {
			LocalDate fDate = formatter.parseLocalDate(firstDate); 
			LocalDate sDate = formatter.parseLocalDate(secondDate);  
			monthdiff = Months.monthsBetween(fDate, sDate).getMonths();
		}
		catch (Exception ex) {
			ex.printStackTrace();
		}
    ...
    public static HashMap<String, String> getUserData(Context	context) {
    	DBA_MASTER_AGENT dbUser = new DBA_MASTER_AGENT(context);
		Cursor c = null;
	...
	public static void setTempactivity(Activity activity) {
		tempActivity = activity;
	}


	public static String getSppaimageurl() {
		return sppaImageURL;
	}
    ...
    public static double getLimit (Context context, String lob) { 
    	
    	DBA_MASTER_AGENT dbAgent = new DBA_MASTER_AGENT(context);
		Cursor c = null;
		...
		try {
			...
			if (lob.equalsIgnoreCase("OTOMATE"))
				return c.getDouble(19);
			else if (lob.equalsIgnoreCase("OTOMATESYARIAH")) 
				return c.getDouble(19);
			else if (lob.equalsIgnoreCase("KONVENSIONAL")) 
				return c.getDouble(20);
			else if (lob.equalsIgnoreCase("TRAVELDOM")) 
				return c.getDouble(21);
			else if (lob.equalsIgnoreCase("TRAVELSAFE")) 
				return c.getDouble(22); 
			else if (lob.equalsIgnoreCase("MEDISAFE")) 
				return c.getDouble(23);
			else if (lob.equalsIgnoreCase("WELLWOMAN")) 
				return c.getDouble(24);
			else if (lob.equalsIgnoreCase("DNO")) 
				return c.getDouble(25);
			else if (lob.equalsIgnoreCase("CARGO")) 
				return c.getDouble(26);
			else if (lob.equalsIgnoreCase("ASRI")) 
				return c.getDouble(30);
			else if (lob.equalsIgnoreCase("ASRISYARIAH")) 
				return c.getDouble(30);
			else if (lob.equalsIgnoreCase("PAAMANAH")) 
				return c.getDouble(29); 
