		...
		return new OnClickListener() {@Override
            ...
            if (Scalar.isOtomateSppa(SyncUnpaidActivity.this, i)) {
                if (!Scalar.isNewSppa(SyncUnpaidActivity.this, i)) {
                    Toast.makeText(SyncUnpaidActivity.this, "Proses pembayaran tidak bisa diproses untuk sppa otomate yang dibuat pada versi aplikasi sebelumnya", Toast.LENGTH_SHORT)
                    .show();
                    return;
                }
            }
...
//						Testing 2, live 1
	...
	public void CheckVehicleListener(Boolean result) {
		if (result) {
            SLProductOtomate otomate = new SLProductOtomate(this, SyncUnpaidActivity.approval.i, SyncUnpaidActivity.this);
            otomate.execute();
