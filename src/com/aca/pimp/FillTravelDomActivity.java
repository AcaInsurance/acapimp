				...
				public void getTravelList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) {
						try {
							...
							kota.setText(hMap.get("TRAVEL_CITY_NAME"));
							ahliwaris.setText(hMap.get("BENEFICIARY_NAME"));
							...
							jmlhari.setText(nf.format(Double.parseDouble(hMap.get("PREMI_DAYS"))));
...
public void btnDeleteClick(View v){
	...
	public void btnNextClick(View v)
	{
		if (PRODUCT_ACTION.equals("APPROVE")) {
			...
			b.putDouble("TSI", 0.0);
			i.putExtras(b);
			Utility.setTempactivity((Activity)FillTravelDomActivity.this);
			startActivity(i);
		}
		else { 
			try{
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillTravelDomActivity.this, "Informasi", "Produksi gagal di-approve").show();
			}
		};
		ws.execute(); 
	}
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillTravelDomActivity.this, "Informasi", "Produksi gagal di-reject").show();
	...
	public void showDialog(String message) {
		...
		dialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) { 
				FillTravelDomActivity.this.finish();
			}
		}); 
	}
