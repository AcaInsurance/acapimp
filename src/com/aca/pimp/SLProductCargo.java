...
public class SLProductCargo extends AsyncTask<String, String, Void>{
	...
	private static final String TAG = "com.aca.pimp.SLProductCargo";
	...
	protected Void doInBackground(String... arg0) {
		...
		*/
		...
		try{
    		...
    		requestinsert.addProperty(Utility.GetPropertyInfo("TipeRate", cProductCargo.getString(31), String.class));
