...
public class SLProductASRI extends AsyncTask<String, String, Void>{
	...
	private DBA_PRODUCT_ASRI dbProductASRI = null;
	...
	public SLProductASRI(Context ctx, long SPPA_ID, Activity a)
	{
	...
	protected Void doInBackground(String... arg0) {
		...
		*/
		...
		try{
			...
			dbProductASRI = new DBA_PRODUCT_ASRI(ctx);
			dbProductASRI.open();
			cProductASRI = dbProductASRI.getRow(SPPA_ID);
    		...
    		requestinsert.addProperty(Utility.GetPropertyInfo("RiskLocationFlag", cProductASRI.getString(2), String.class));
