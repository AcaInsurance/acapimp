...
public class InfoTravelActivity extends ControlNormalActivity {
	...
	{
		ShowDialog(R.layout.dialog_travel_safe_riskinsured, "Table Premi", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_travel_safe_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_travel_safe_procedure, "Ketentuan", R.id.dlgOK);
	}
