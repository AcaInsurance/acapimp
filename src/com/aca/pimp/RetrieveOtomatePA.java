...
class RetrieveOtomatePA extends AsyncTask<String, Void, Void>{
    ...
    private static String SOAP_ACTION = "http://tempuri.org/GetPremiPAOtomate";     
    private static String METHOD_NAME= "GetPremiPAOtomate";
	...
	public RetrieveOtomatePA (Activity ctx, String idKtp ){
		this.ctx = ctx;
		this.idKtp = idKtp;
	...
	protected Void doInBackground(String... params) {
		...
		try{
            ...
            if(responseBody.getPropertyCount() > 0) {
                ...
                map.put("PA", tableRow.getPropertySafelyAsString("PA").toString()); 
