...
public class InfoTokoActivity extends ControlNormalActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_toko, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_toko_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_toko_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_toko_procedure, "Prosedur Klaim", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v) {
		...
		{
			Intent i = new Intent(getBaseContext(),  FillTokoActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
