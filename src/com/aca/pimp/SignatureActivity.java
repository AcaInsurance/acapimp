...
public class SignatureActivity extends ControlNormalActivity {
	...
	private LinearLayout laytb, layApprove;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		laytb = (LinearLayout)findViewById(R.id.tb);
...
//			}
			...
			tempDir = Environment.getExternalStorageDirectory() +"/LoadImgPimp/" + String.valueOf(SPPA_ID);
