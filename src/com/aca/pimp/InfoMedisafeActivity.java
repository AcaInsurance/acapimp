...
public class InfoMedisafeActivity extends ControlNormalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_medisafe);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_medisafe, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_medisafe_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_medisafe_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_medisafe_procedure, "Prosedur Klaim", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v) {
		...
		{
			Intent i = new Intent(getBaseContext(),  FillMedisafe.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
