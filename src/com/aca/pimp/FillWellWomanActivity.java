...
//				changeLayout();
	...
	private void getIntentData() {
		...
		if (getIntent().getExtras() != null) {
			...
			LoadPimpWellWoman ws = new LoadPimpWellWoman(this, hmap) {

				@Override
				public void getWellWomanList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) {
						try {
							...
							q2note.setText(hMap.get("Q2_NOTE"));
							q3note.setText(hMap.get("Q3_NOTE"));
							q4note.setText(hMap.get("Q4_NOTE"));
							...
							if(hMap.get("Q3_FLAG").equals("1"))
								q3flag.setChecked(true);
							
							if(hMap.get("Q4_FLAG").equals("1"))
			...
			LoadPimpBene wsBene = new LoadPimpBene(this, hmap) {
				...
				protected void getBeneList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) {
						...
						benename1.setText(arrList.get(0).get("NAME"));
						benerelation1.setText(arrList.get(0).get("RELATION"));
...
public void btnDeleteClick(View v){
	...
	public void btnNextClick(View v) {
		if (PRODUCT_ACTION.equals("APPROVE")) {
			...
			b.putDouble("TSI", 0.0);
			i.putExtras(b);
			Utility.setTempactivity((Activity)FillWellWomanActivity.this);
			startActivity(i);
		}
		else { 
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillWellWomanActivity.this, "Informasi", "Produksi gagal di-approve").show();
			}
		};
		ws.execute(); 
	}
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillWellWomanActivity.this, "Informasi", "Produksi gagal di-reject").show();
