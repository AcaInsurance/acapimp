...
//					custList = Utility.getCustData(FillAsriActivity.this, customerno.getText().toString());
	...
	public void btnNextClick(View v) throws ParseException
	{
		if (PRODUCT_ACTION.equals("APPROVE")) {
			...
			i.putExtras(b);
			Utility.setTempactivity((Activity)FillAsriActivity.this);
			startActivity(i);
		}
		else { 
			try{
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillAsriActivity.this, "Informasi", "Produksi gagal di-approve").show();
			}
		};
		ws.execute(); 
	}
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillAsriActivity.this, "Informasi", "Produksi gagal di-reject").show();
