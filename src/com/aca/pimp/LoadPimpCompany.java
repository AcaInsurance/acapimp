...
public abstract class LoadPimpCompany extends AsyncTask<String, Void, Void>{
    ...
    private static String SOAP_ACTION = "http://tempuri.org/GetCompany";     
    private static String METHOD_NAME= "GetCompany";
     
    private ArrayList<HashMap<String, String>> arrList; 
    private HashMap<String, String> hmap;
    
    
    public LoadPimpCompany (Context ctx, HashMap<String, String> hmap){
    	this.ctx = ctx;
    	this.hmap = hmap;
	...
	protected Void doInBackground(String... params) {
		...
		try{
            ...
            for(int i = 0; i < iTotalDataFromWebService; i++)
            {
	            ...
	            map.put("COMPANY_KEY", Utility.isAnytype(tableRow.getPropertySafelyAsString("COMPANY_KEY"))); 
	            map.put("COMPANY_NAME", Utility.isAnytype(tableRow.getPropertySafelyAsString("COMPANY_NAME")));
	            map.put("COMPANY_BUSINESS_TYPE", Utility.isAnytype(tableRow.getPropertySafelyAsString("COMPANY_BUSINESS_TYPE")));
	...
	protected abstract void getCompanyList(ArrayList<HashMap<String, String>> arrList);
