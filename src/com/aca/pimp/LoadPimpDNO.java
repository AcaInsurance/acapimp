...
public abstract class LoadPimpDNO extends AsyncTask<String, Void, Void>{
    ...
    private static String SOAP_ACTION = "http://tempuri.org/GetProductDNO";     
    private static String METHOD_NAME= "GetProductDNO";
     
    private ArrayList<HashMap<String, String>> arrList; 
    private HashMap<String, String> hmap;
    
    
    public LoadPimpDNO (Context ctx, HashMap<String, String> hmap){
    	this.ctx = ctx;
    	this.hmap = hmap;
		...
		try{
            ...
            for(int i = 0; i < iTotalDataFromWebService; i++)
            {
	            ...
	            HashMap<String, String> map = new HashMap<String, String>();  
	             ...
	             if (map.get("Q1_FLAG").equalsIgnoreCase("0"))
	            	 map.put("Q1_DATE",  tableRow.getPropertySafelyAsString("Q1_DATE"));
	             else
	            	 map.put("Q1_DATE", Utility.formatDateSQL(Utility.isAnytype(tableRow.getPropertySafelyAsString("Q1_DATE"))));
	...
	protected abstract void getDNOList(ArrayList<HashMap<String, String>> arrList);
