...
public class InfoOtomateSyariahActivity extends ControlNormalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_otomate_syariah);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_otomate_syariah, menu);
		return true;
	}
	...
	public void btnBuyClick(View v)
	{
		...
		{
			Intent i = new Intent(getBaseContext(),  FillOtomateSyariahActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
	...
	{
		ShowDialog(R.layout.dialog_otomate_syariah_rate, "Rate/Tarif", R.id.dlgOK);
	}
	
	public void btnInsuredRiskClick(View v)
	{
		ShowDialog(R.layout.dialog_otomate_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_otomate_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_otomate_procedure, "Prosedur Klaim", R.id.dlgOK);
	}
