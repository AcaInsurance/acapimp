...
public class SLProductOtomateSyariah extends AsyncTask<String, String, Void>{
	@SuppressWarnings("unused")
	private static final String TAG = "com.aca.pimp.SLProductOtomateSyariah";
	...
	private DBA_PRODUCT_OTOMATE_SYARIAH dbProductOtomate = null;
	...
	public SLProductOtomateSyariah(Context ctx, long SPPA_ID, Activity a)
	{
	...
	protected Void doInBackground(String... arg0) {
		...
		*/
		...
		try{
			...
			dbProductOtomate = new DBA_PRODUCT_OTOMATE_SYARIAH(ctx);			
