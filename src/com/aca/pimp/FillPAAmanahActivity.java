...
//			MAX_DISCOUNT = Utility.getMaxDiscount(getBaseContext(), "29");
	...
	private void getIntentData() {
		...
		if (getIntent().getExtras() != null) {
			...
			LoadPimpPA ws = new LoadPimpPA(this, hmap) {

				@Override
				public void getPAList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) {
						...
						try {
							...
							nilaipertanggungan.setText(nf.format(Double.parseDouble(hMap.get("TSI_1"))));			
			...
			LoadPimpBene wsbene = new LoadPimpBene(this, hmap) {
				
				@Override
				protected void getBeneList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) { 						   
						fillBene(namaahliwaris1, hubahliwaris1, alamatahliwaris1, arrList.get(0));
						fillBene(namaahliwaris2, hubahliwaris2, alamatahliwaris2, arrList.get(1));
						fillBene(namaahliwaris3, hubahliwaris3, alamatahliwaris3, arrList.get(2)); 
					}
				}

				private void fillBene(EditText nama, EditText hub, EditText alamat, HashMap<String, String> hMap) {
					nama.setText(hMap.get("NAME"));
					hub.setText(hMap.get("RELATION"));
					alamat.setText(hMap.get("ADDRESS"));
...
public void btnDeleteClick(View v){
	...
	public void btnNextClick(View v) throws ParseException {
		if (PRODUCT_ACTION.equals("APPROVE")) {
			...
			i.putExtras(b);
			Utility.setTempactivity((Activity)FillPAAmanahActivity.this);
			startActivity(i);
		}
		else { 
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillPAAmanahActivity.this, "Informasi", "Produksi gagal di-approve").show();
			}
		};
		ws.execute(); 
	}
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillPAAmanahActivity.this, "Informasi", "Produksi gagal di-reject").show();
	...
	public void showDialog(String message) {
		...
		dialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) { 
				FillPAAmanahActivity.this.finish();
			}
		}); 
	}
}
