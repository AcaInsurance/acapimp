...
public class FillAsriSyariahActivity extends ControlNormalActivity implements InterfaceCustomer {

	ArrayList<HashMap<String, String>> custList ;
	
	private Context context = null;
	private double maxTSI = 2000000000;
	...
	private LinearLayout layNext, layApprove;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fill_asri_syariah);
	
		context = FillAsriSyariahActivity.this;
...
//				changeLayout();
	...
	private void disableListener() {
		swiAlamat.setOnCheckedChangeListener(null);
	}
	...
	private void getIntentData() {
		...
		if (getIntent().getExtras() != null) {
			...
			LoadPimpAsri ws = new LoadPimpAsri(this, hmap) {

				@Override
				public void getAsriList(ArrayList<HashMap<String, String>> arrList) {
					if (arrList != null) { 
						try {
							...
							luas.setText(hMap.get("BUILDING_SIZE"));
							hargabangunan.setText(nf.format(Double.parseDouble(hMap.get("BUILDING_SI"))));
							hargaperabotan.setText(nf.format(Double.parseDouble(hMap.get("CONTENT_SI"))));
							totalharga.setText(nf.format(Double.parseDouble(hMap.get("BUILDING_SI")) + Double.parseDouble(hMap.get("CONTENT_SI"))));
							 
							if (hMap.get("RISK_LOCATION_FLAG").equals("1")) 
								swiAlamat.setChecked(true); 
							else 
								swiAlamat.setChecked(false);
							
							alamat.setText(hMap.get("RISK_ADDRESS"));							
							cityName.setText(hMap.get("RISK_CITY"));			
							kodepos.setText(hMap.get("RISK_POST_CODE"));			
							
							etFromDate.setText(hMap.get("EFF_DATE"));
							etToDate.setText(hMap.get("EXP_DATE"));
...
//		MAX_DISCOUNT = Utility.getMaxDiscount(getBaseContext(), "31"); 
	...
	private void getCustomerData () {
		RetrieveCustomer retrieveCustomer = new RetrieveCustomer(FillAsriSyariahActivity.this, customerno.getText().toString());
	...
	public void getCustomerList(ArrayList<HashMap<String, String>> custList) {
		if (custList != null) {
			...
			Utility.showCustomDialogInformation(FillAsriSyariahActivity.this, "Informasi", "Gagal ambil data alamat nasabah. Mohon alamat diketik saja");
	...
	private void LoadDB() {
		...
		DBA_PRODUCT_ASRI_SYARIAH dba = null;
		...
		try{
			...
			dba = new DBA_PRODUCT_ASRI_SYARIAH(getBaseContext());
			...
			public void onFocusChange(View arg0, boolean hasFocus) {
				if(hasFocus)
					...
					if (!flag) {
						...
						Utility.showCustomDialogInformation(FillAsriSyariahActivity.this, "Warning", "Tanggal mulai minimal besok hari");
		...
		swiAlamat.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if(swiAlamat.isChecked() && !customerno.getText().toString().isEmpty()){
					getCustomerData();
//					custList = Utility.getCustData(FillAsriSyariahActivity.this, customerno.getText().toString());
				}
				else {
					alamat.setText("");
					kodepos.setText("");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.fill_asri_syariah, menu);
		return true;
	}
	...
	public void btnNextClick(View v) throws ParseException
	{
		if (PRODUCT_ACTION.equals("APPROVE")) {
			...
			Utility.setTempactivity((Activity)FillAsriSyariahActivity.this);
			startActivity(i);
		}
		else { 
			try{
				validasiNext();
				if(flag != 0)
					Utility.showCustomDialogInformation(FillAsriSyariahActivity.this, "Warning", UIErrorMessage);
	...
	public class DeleteSPPA extends AsyncTask<Void, Void, Void> 
    {
		...
		protected void onPreExecute()  {
		 ...
		 protected Void doInBackground(Void... params) {
				...
				DBA_PRODUCT_ASRI_SYARIAH dba2 = null;
				...
				try 
				{
					...
					dba2 = new DBA_PRODUCT_ASRI_SYARIAH(context);
					dba2.open();
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillAsriSyariahActivity.this, "Informasi", "Produksi gagal di-approve").show();
			}
		};
		ws.execute(); 
	}
		...
		ApproveProduction ws = new ApproveProduction(this, hmap) { 
			...
			protected void getFlagApprovalProduction(Boolean flag) {
				if (flag) 
					...
					Utility.showCustomDialogInformation(FillAsriSyariahActivity.this, "Informasi", "Produksi gagal di-reject").show();
	...
	public void showDialog(String message) {
		...
		dialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) { 
				FillAsriSyariahActivity.this.finish();
			}
		}); 
	}
}
