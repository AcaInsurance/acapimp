...
public class LOAD_ASRI extends AsyncTask<String, Void, Void>{
    ...
    public LOAD_ASRI (Context ctx, String policyNo, Long SPPA_ID, ArrayList<HashMap<String, String>> polis){
    	this.ctx = ctx;
    	noPolis = policyNo;
    	polisList = polis;
...
protected void onPostExecute(Void result) {
		...
		DBA_PRODUCT_ASRI dba = new DBA_PRODUCT_ASRI(ctx);
