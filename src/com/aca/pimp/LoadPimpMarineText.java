...
public abstract class LoadPimpMarineText extends AsyncTask<String, Void, Void>{
    ...
    private static String SOAP_ACTION = "http://tempuri.org/GetMarineText";     
    private static String METHOD_NAME= "GetMarineText";
     
    private ArrayList<HashMap<String, String>> arrList; 
    private HashMap<String, String> hmap;
    
    
    public LoadPimpMarineText (Context ctx, HashMap<String, String> hmap){
    	this.ctx = ctx;
    	this.hmap = hmap;
	...
	protected abstract void getMarineList(ArrayList<HashMap<String, String>> arrList);
