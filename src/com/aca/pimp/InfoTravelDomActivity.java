...
public class InfoTravelDomActivity extends ControlNormalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_travel_dom);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_travel_dom, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_travel_dom_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_travel_dom_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_travel_dom_procedure, "Ketentuan", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v) {
		...
		{
			Intent i = new Intent(getBaseContext(),  FillTravelDomActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
