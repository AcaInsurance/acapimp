		...
		protected Void doInBackground(String... params) {
			...
			try{
	            ...
	            for(int i = 0; i < iTotalDataFromWebService; i++)
	            {
		            ...
		            map.put("PREMI", nf.format(nf.parse(tableRow.getPropertySafelyAsString("Premi")).doubleValue())); 
		            
		            double selisih = Double.parseDouble(tableRow.getPropertySafelyAsString("SelisihPremi").toString());
		            double kenaikan, penurunan;
		            ...
		            map.put("KENAIKAN_PREMI", nf.format(kenaikan)); 
		            map.put("PENURUNAN_PREMI", nf.format(penurunan)); 
				...
				if(error){
					...
					ListAdapter adapter = new SimpleAdapter(SPPAActivity.this
	            			...
	            			,new int[] { R.id.txtProductionPolicyNo,
										...
										R.id.txtPremi,
										R.id.txtPenurunanPremi,
										R.id.txtKenaikanPremi,
										R.id.btnSyncPolis})
					{
						@Override
	...
	private OnClickListener insertDB (final String noPolis){
		return new OnClickListener() {
			...
			public void onClick(View v) {
				...
				resultExp = Utility.compareDate(dateExp, today);
