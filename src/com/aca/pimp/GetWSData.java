			...
			try{	
				...
				try {
					...
					for (int i = 0 ; i < custList.size(); i ++) {
						...
						dba.insert(Utility.isAnytype(map.get("JNP")), 
								Utility.isAnytype(map.get("WILAYAH")),
								Utility.isAnytype(map.get("VEHICLE_CATEGORY")),
								Utility.isAnytype(map.get("EXCO")),
								Utility.isAnytype(map.get("RATE_BAWAH")),
								Utility.isAnytype(map.get("RATE_TENGAH")),
								Utility.isAnytype(map.get("RATE_ATAS")),
								Utility.isAnytype(map.get("JAMINAN")));
					}
