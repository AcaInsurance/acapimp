...
public class InfoExecutiveActivity extends ControlNormalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_info_executive);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.info_executive, menu);
		return true;
	}
	...
	{
		ShowDialog(R.layout.dialog_executive_safe_riskinsured, "Resiko Dijamin", R.id.dlgOK);
	}
	
	public void btnFacilityClick(View v)
	{
		ShowDialog(R.layout.dialog_executive_safe_facility, "Fasilitas Tambahan", R.id.dlgOK);
	}
	
	public void btnProcedureClaimClick(View v)
	{
		ShowDialog(R.layout.dialog_executive_safe_procedure, "Prosedur Klaim", R.id.dlgOK);
	}
	...
	public void btnBuyClick(View v)
	{
		...
		{
			Intent i = new Intent(getBaseContext(),  FillExecutiveActivity.class);
			i.putExtras(b);
			startActivity(i);
			this.finish();
		}
