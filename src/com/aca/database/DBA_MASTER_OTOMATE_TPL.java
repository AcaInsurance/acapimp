...
public class DBA_MASTER_OTOMATE_TPL{

	public static final String TPL = "TPL";
    public static final String PREMI = "PREMI"; 
     
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_OTOMATE_TPL";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_OTOMATE_TPL (TPL TEXT, PREMI TEXT);";
    ...
    public DBA_MASTER_OTOMATE_TPL(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_OTOMATE_TPL open() throws SQLException 
    {
