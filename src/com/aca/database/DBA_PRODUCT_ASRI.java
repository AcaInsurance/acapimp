...
public class DBA_PRODUCT_ASRI {
    ...
    private static final String DATABASE_TABLE = "PRODUCT_ASRI";
     static final String DATABASE_CREATE =
        "CREATE TABLE PRODUCT_ASRI (ALAMAT_SAMA NUMERIC, _id INTEGER PRIMARY KEY, PRODUCT_MAIN_ID NUMERIC, LUAS_BANGUNAN NUMERIC, " +
    ...
    public DBA_PRODUCT_ASRI(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_PRODUCT_ASRI open() throws SQLException 
    {
    ...
    public long initialInsert(long product_main_id, String alamat_sama, int luas, double harga_bangunan, double harga_perabot, double total_harga, String alamat, String rt, String rw,
    		...
    		String tgl_mulai, String tgl_akhir, double rate, double premi, double materai, double polis, double total, String product_name, String customer_name,
    		String kota_desc) 
    {
