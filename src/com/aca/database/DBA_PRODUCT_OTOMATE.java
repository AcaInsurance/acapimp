...
public class DBA_PRODUCT_OTOMATE {
    ...
    public DBA_PRODUCT_OTOMATE(Context ctx) 
    {
        this.context = ctx;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper 
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) 
        {
            ...
            db.execSQL("DROP TABLE IF EXISTS PRODUCT_OTOMATE");
            onCreate(db);*/
        }
    }    

    //---opens the database---
    public DBA_PRODUCT_OTOMATE open() throws SQLException 
    {
    		...
    		) 
    {
        ...
        initialValues.put(PRODUCT_NAME, "OTOMATE");
