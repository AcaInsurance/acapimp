...
public class DBA_MASTER_CAR_BRAND {

	public static final String CODE = "CODE";
    public static final String DESCRIPTION = "DESCRIPTION";
    
    private static final String TAG = "DBA_MASTER_CAR_BRAND";
    
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_CAR_BRAND";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_CAR_BRAND (CODE TEXT, DESCRIPTION TEXT);";
    ...
    public DBA_MASTER_CAR_BRAND(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_CAR_BRAND open() throws SQLException 
    {
