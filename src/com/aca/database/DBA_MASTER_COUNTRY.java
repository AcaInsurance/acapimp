...
public class DBA_MASTER_COUNTRY {

	public static final String CODE = "CODE";
    public static final String DESCRIPTION = "DESCRIPTION";
    public static final String FLAG = "FLAG";
    
    private static final String TAG = "DBA_MASTER_COUNTRY";
    
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_COUNTRY";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_COUNTRY (CODE TEXT, DESCRIPTION TEXT, FLAG TEXT);";
    ...
    public DBA_MASTER_COUNTRY(Context ctx) 
    {
        this.context = ctx;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper 
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) 
        {
            ...
            db.execSQL("DROP TABLE IF EXISTS MASTER_COUNTRY");
            onCreate(db);
            */
        }
    }    
    ...
    //---opens the database---
    public DBA_MASTER_COUNTRY open() throws SQLException 
    {
    ...
    public void insertSchengen () {
    	db.execSQL("INSERT INTO MASTER_COUNTRY (CODE, DESCRIPTION, FLAG) SELECT CODE, DESCRIPTION, FLAG FROM MASTER_SCHENGEN");
