...
public class DBA_MASTER_OTOMATE_PA{

	public static final String PA = "PA";
    public static final String PREMI = "PREMI"; 
     
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_OTOMATE_PA";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_OTOMATE_PA (PA TEXT, PREMI TEXT);";
    ...
    public DBA_MASTER_OTOMATE_PA(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_OTOMATE_PA open() throws SQLException 
    {
