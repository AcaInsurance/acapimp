...
public class DBA_MASTER_TRAVELSAFE_INT_RATE {
    ...
    private static final String TAG = "DBA_MASTER_TRAVELSAFE_INT_RATE";
    
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_TRAVELSAFE_INT_RATE";

     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_TRAVELSAFE_INT_RATE (AREA TEXT, COVERAGE TEXT, DURATION_CODE TEXT, PREMI NUMERIC, MAX_BENEFIT NUMERIC);";
    ...
    public DBA_MASTER_TRAVELSAFE_INT_RATE(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_TRAVELSAFE_INT_RATE open() throws SQLException 
    {
    ...
    public Cursor getRate(String area, String coverage, String durationCode) 
    {
    	...
    	if (area.equals("1"))
    		...
    		area = "B" ;
    	*/
    	Log.d ("area di table ", area);
    	return db.rawQuery("SELECT AREA, COVERAGE, DURATION_CODE, PREMI, MAX_BENEFIT FROM MASTER_TRAVELSAFE_INT_RATE" +
    			" WHERE AREA = ? AND" +
    			"		COVERAGE = ? AND " +
    			"		DURATION_CODE  = ? " +
