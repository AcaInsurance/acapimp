...
public class DBA_MASTER_PA_AMANAH_RATE {
    ...
    private static final String TAG = "DBA_MASTER_PA_AMANAH_RATE";
    
    private static final String DATABASE_NAME = "AMM_VERSION_BIG";
    private static final String DATABASE_TABLE = "MASTER_PA_AMANAH_RATE";
     static final String DATABASE_CREATE =
        "CREATE TABLE MASTER_PA_AMANAH_RATE (TYPE NUMERIC, PLAN NUMERIC, AGE NUMERIC, PREMI NUMERIC);";
    ...
    public DBA_MASTER_PA_AMANAH_RATE(Context ctx) 
    {
        this.context = ctx;
    ...
    //---opens the database---
    public DBA_MASTER_PA_AMANAH_RATE open() throws SQLException 
    {
    ...
    {
    	return db.rawQuery("SELECT TYPE, PLAN, AGE, PREMI FROM MASTER_PA_AMANAH_RATE" +
    			" WHERE TYPE = ? AND" +
    			"		PLAN = ? AND " +
    			"		AGE  = ? " +
